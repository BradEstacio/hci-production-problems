...
Copy and paste the URL for your personal fork of the repository here: https://github.com/BradEstacio/project2
...
```
origin	git@github.com:BradEstacio/project2.git (fetch)
origin	git@github.com:BradEstacio/project2.git (push)
upstream	git@github.com:ITMD362-Team-BEJJ/project2.git (fetch)
upstream	git@github.com:ITMD362-Team-BEJJ/project2.git (push)
```
...
Copy and paste the URL of your pull request here: https://github.com/ITMD362-Team-BEJJ/project2/pull/2
